...
#from gym_aloha.tasks.sim import START_ARM_POSE   # Uncomment if you want to change it here instead of loading from a fixed data point
...
class AlohaEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        if "transfer_cube" in self.task:
            ...
            # print("******* Initial Box Pose inside gym_aloha/env.p",BOX_POSE[0])
        ...
        #print("****** Raw ob",raw_obs)
        # print("****** format_raw_obs",observation)
...
### Added my me       
    ...
    def get_state(self):
        env_pose, box_pose, env_vel = self._env.task.get_env_state_all(self._env.physics)
        return env_pose, box_pose, env_vel

    def set_state(self,env_pose, box_pose, env_vel):
        self._env.task.set_env_state(self._env.physics, env_pose, box_pose, env_vel)
        
    #     BOX_POSE = self.qpose[-14:]
    #     START_ARM_POSE = self.qpose[16:]  ## Need to change based on get_observation in sim.py
